...
%%%%%%%%%%%%%%%%%%%%%%%%% TIEMPO %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tf=19.5;             % Tiempo de simulación en segundos (s)
...
v=[6*ones(1,10) 0*ones(1,10) 5*ones(1,10) 0*ones(1,10) 4*ones(1,10) 0*ones(1,10) 5*ones(1,10) 0*ones(1,10) 6*ones(1,10) 0*ones(1,10) 6.5*ones(1,10) 0*ones(1,10) 2*ones(1,10) 0*ones(1,10) 3*ones(1,10) 0*ones(1,10) 3*ones(1,10) 0*ones(1,10) 2.2*ones(1,10) 0*ones(1,10) 1.3*ones(1,10) 0*ones(1,10) 6*ones(1,10) 0*ones(1,10) 8*ones(1,10) 0*ones(1,10) 6*ones(1,10) 0*ones(1,10) 6*ones(1,10) 0*ones(1,10) 1*ones(1,10) 0*ones(1,10) 6*ones(1,10) 0*ones(1,10) 6.5*ones(1,10) 0*ones(1,10) 2*ones(1,10) 0*ones(1,10) 3*ones(1,10) 0*ones(1,11)];

w=[0*ones(1,10) -1.5*pi*ones(1,10) 0*ones(1,10) -pi*1.10*ones(1,10) 0*ones(1,10) 1.6*pi*ones(1,10) 0*ones(1,10) pi/1.25*ones(1,10) 0*ones(1,10) -pi*1.5*ones(1,10) 0*ones(1,10) 2*pi*ones(1,10 ...
    ) 0*ones(1,10) pi*.7*ones(1,10) 0*ones(1,10) 2*pi*ones(1,10) 0*ones(1,10) -pi*.7*ones(1,10) 0*ones(1,10) pi*.7*ones(1,10) 0*ones(1,10) pi*ones(1,10) 0*ones(1,10) -pi/.65*ones(1,10) 0*ones(1,10) pi*1.5*ones(1,10) 0*ones(1,10) pi*2*ones(1,10) 0*ones(1,10) pi*ones(1,10) 0*ones(1,10) pi/1.25*ones(1,10) 0*ones(1,10) -pi*1.5*ones(1,10) 0*ones(1,10) 2*pi*ones(1,10 ...
    ) 0*ones(1,10) pi*.7*ones(1,10) 0*ones(1,10) 0*ones(1,81)];
...
axis([-10 10 -2 20 0 5]); % Ingresar limites minimos y maximos en los ejes x y z [minX maxX minY maxY minZ maxZ]
